# A data journal that investigates the implementation, adoption and impact of semantic search to augment the support services workflow at a large multi national
